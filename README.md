...
EDF, Esperanto, Fit2D (binary and mask), GE, mar345, MRC, Netpbm, R-AXIS, SPE, TIFF (plain,
Pilatus and MarCCD) and NumPy. See [DESIGN.md](DESIGN.md) for the full architecture and the format roadmap.
